<div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Cliente Eliminado</h1>
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>CLIENTES
                        <a href="{{ url('admin/cliente/create') }}" class="btn btn-primary float-end">Añadir Cliente</a>
                    </h4>
                </div>
                <div class="card-body">
                    <div>
                        ...
                        <Tbody id="tbody-mantenimientos">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" wire:click="deleteCliente({{$cliente->id}})" data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
                            @endforeach
                        </Tbody>
