        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>CATEGORIA &nbsp;&nbsp;
                        @can('recuperar-categoria')
                        <button id="btnrestore" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalkits"> Restaurar Eliminados
                        </button>
                        @endcan
                        @can('crear-categoria')
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="mitabla" style="width: 100%;" name ="mitabla">
