            ...
            <div class="card">
                <div class="card-header">
                    <h4>STOCK DE INVENTARIO DE PRODUCTOS: &nbsp;  &nbsp;  &nbsp;  &nbsp; 
                         <a type="button"  class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#modalkits">Consultar Stock de Kits</a>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                        <table class="table table-row-bordered gy-5 gs-5" style="width: 100%" id="mitabla1" name="mitabla1">
                            <thead class="fw-bold text-primary">
                                <tr>
                                    <th>Nombre</th>
                                    <th>Precio</th> 
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="cerrartoast()"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input type="text" class="form-control " id="verKit" readonly>
                                        </div>
                                        <div class="col-sm-6  mb-3">
    ...
    mikit.addEventListener('show.bs.modal', event => { 
        ...
        $.get(urlstockkit+'/'+ idkit, function(data) {  
            ...
            for(var i =0 ; i<data.length;i++){
                ...
                '"><td>'+ data[i].empresa+
                '</td><td>'+ data[i].stock+  
                '</td><td><button type="button" class="btn btn-info" onclick="verstocks(' + idkit+',' + data[i].id+
                ')" >Ver</button></td>  </tr>'; 
