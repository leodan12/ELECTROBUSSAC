                ...
                <form action="{{ url('admin/venta/'.$venta->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="factura" id="factura" class="form-control borde" readonly required value="{{ $venta->factura }}"/>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="costoventa" id= "costoventa"  step="0.01" class="form-control borde required" required readonly value="{{ $venta->costoventa }}"/>
                            ...
                            <tbody>
                                ...
                                @foreach($detallesventa as $detalle)
                                    ...
                                    <tr id="fila{{$ind}}">
                                        ...
                                        <td><button type="button" class="btn btn-danger" onclick="eliminarFila( '{{ $ind }}' ,'{{ $datobd }}', '{{$detalle->iddetalleventa}}'  )" data-id="0"><i class="bi bi-trash-fill"></i>ELIMINAR</button></td>
