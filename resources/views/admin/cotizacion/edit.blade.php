...
<div class="row">
    ...
    @endif
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('admin/cotizacion/'.$cotizacion->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="fecha" id="fecha" class="form-control borde" readonly required value="{{ $cotizacion->fecha }}"/>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="fechav" id="fechav" class="form-control borde" value="{{ $cotizacion->fechav }}"/>
                        ...
                        <div class="col-md-6 mb-3">
                           ...
                           <select  class="form-select select2 borde" name="company_id" required>
                               ...
                               <option value="{{ $company->id }}" {{$company->id==$cotizacion->company_id ? 'selected':''}} >{{ $company->nombre }}</option>
                               @endforeach
                           </select>
                       </div>
                       ...
                       <select  class="form-select select2 borde" name="cliente_id" required>
                           ...
                           <option value="{{ $cliente->id }}" {{$cliente->id==$cotizacion->cliente_id ? 'selected':''}} >{{ $cliente->nombre }}</option>
                           @endforeach
                       </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @endif 
                            <input type="number" name="costoventasinigv" id= "costoventasinigv"  min="0.1" step="0.01" class="form-control borde required" required readonly value="{{ $cotizacion->costoventasinigv }}" />
                        </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="input-group">
                            ...
                            @endif
                            <input type="number" name="costoventaconigv" id= "costoventaconigv"  min="0.1" step="0.01" class="form-control borde required" required  readonly value="{{ $cotizacion->costoventaconigv }}"/>
                        </div>
                        </div>
